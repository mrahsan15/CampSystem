                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="ecommerce_dashboard.jsp" class="nav-link ">
                                        <i class="icon-home"></i>
                                        <span class="title">Dashboard</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item ">
                                            <a href="login.jsp" class="nav-link " target="_blank"> Login Page 1 </a>
                                        </li>
                                        <li class="nav-item ">
                        ...
                        <div class="col-md-12 page-404">
                            ...
                            <div class="details">
                                ...
                                <p> We can not find the page you're looking for.
                                    <br/>
                                    <a href="dashboard.jsp"> Return home </a> or try the search bar below. </p>
                                <form action="#">
