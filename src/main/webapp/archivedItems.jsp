...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            ...
            <%
            try{
                ResultSet complainrecords=  connection.createStatement().executeQuery("SELECT * from complainbook WHERE Archived = 1 ORDER BY DateTime DESC");
...
"<tr>\n"
        ...
        + "<td class=\"center\"> "+dateoutput.format(date)+"</td>"
