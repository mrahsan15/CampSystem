<%-- 
    Document   : checkout
    Created on : Dec 21, 2016, 11:00:44 AM
    Author     : ahsan
--%>
...
<%
    ...
    ResultSet stfid = statement.executeQuery("SELECT JobTitle from campstaff WHERE ID = " + campstaffid);
    stfid.next();
    String JobTitle = stfid.getString("JobTitle");
...
<%    System.out.println("Company ID: " + request.getParameter("companyid"));
    String checkouttemp = request.getParameter("checkoutid");
    String checkoutdate = request.getParameter("checkoutdate");
    System.out.println("Checkout Parameter: " + checkouttemp);

    try {
        if (checkouttemp != null) {
            Statement checkoutstatement = connection.createStatement();
            String checkoutquery = "UPDATE datarecord SET CheckOut = '"+checkoutdate+" 00:00:00' WHERE datarecord.ID = " + checkouttemp;
            checkoutstatement.executeUpdate(checkoutquery);
        }
    } catch (Exception ex) {
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Camp System - Check Out</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">Guest Check out
                        <small> </small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet-body flip-scroll">
                        <table class="table table-bordered table-striped table-condensed flip-content">
                            ...
                            <tbody>
                                <% 
                                    String query = "SELECT * from datarecord WHERE CompanyName = " + CompanyId + " AND CheckOut IS NULL";
                                    ...
                                    while (rs.next()) {
                                        ...
                                        out.println("<input type=\"hidden\" name=\"checkoutid\" value=\" " + id + "\" ");
                                        out.println("<input type=\"hidden\" name=\"companyid\" value=\"" + companyid + "\" ");
%>
                            <div class="row">
                                <div class="col-md-6">
                                    <input class="form-control" type="date" name="checkoutdate" value=<% 
                                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                                        out.println(sdf.format(new java.util.Date())); 
                                    %> >
                                <%
                                        
                                        out.println("</div></div>"+ "<button type=\"submit\" name=\"companyid\" value=\""+companyid+"\" class=\"btn red\">Check Out</button>"+"</form>");
                                        out.println("</td>");
                                    ...
                                    if (count == 0) {
                                        out.println(""
                                                + "<td colspan=\"9\" align=\"center\">No Data Record Found!</td>");
                                    }
                                %>  
