<%-- 
    Document   : guestcompanies
    Created on : Dec 19, 2016, 5:35:26 PM
    Author     : ahsan
--%>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Guest Companies List
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-comments"></i>Guest Companies </div>
                                    <div class="tools">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                String updatequery = "SELECT * from guestcompanies";
                                                try{
                                                    Statement updatestatement  = connection.createStatement();
                                                    ResultSet guestCompaniesSet = updatestatement.executeQuery(updatequery);
                                                    while(guestCompaniesSet.next()){
                                                            int id = guestCompaniesSet.getInt("ID");
                                                            String CompanyName = guestCompaniesSet.getString("Name");
