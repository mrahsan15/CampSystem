                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        while(productset.next()){
                                            out.println("<tr>");
                                            out.println("<td>"+productset.getString("PRODUCT_CODE_ID")+"</td>");
                                            out.println("<td>"+productset.getString("PRODUCT_NAME")+"</td>");
                                            out.println("<td>"+productset.getString("PRODUCT_DESCRIPTION")+"</td>");
                                            out.println("<td>"+productset.getString("PRODUCT_UNIT")+"</td>");
                                            out.println("<td>"+productset.getString("PRODUCT_TYPE")+"</td>");
                                            out.println("</tr>");
                                        }
