<%-- 
    ...
    Created on : Dec 19, 2016, 1:23:03 PM
    Author     : ahsan
                                ...
                                <form action="uploadfile" method="post" name="mandaysform" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <p>
                                            ...
                                            <input type="file" class="btn btn-outline sbold blue" accept=".xls,.xlsx" name="file" />
                                        </p>
                                    </div>
                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <tbody>-->
                                        <%
//                                            FileInputStream file = new FileInputStream("/home/ahsan/temp/campsystemtemplate.xlsx");
//                                            XSSFWorkbook workbook = new XSSFWorkbook(file);
//                                            XSSFSheet sheet = workbook.getSheet("mandays");
//                                            int rowcount = 0;
//                                            XSSFRow row = sheet.getRow(rowcount);
//                                            XSSFCell importid = row.getCell(0);
//                                            XSSFCell importname= row.getCell(1);
//                                            XSSFCell importroomno = row.getCell(2);
//                                            XSSFCell importroomtype = row.getCell(3);
//                                            XSSFCell importfoodtype = row.getCell(4);
//                                            XSSFCell importbathroom = row.getCell(5);
//                                            XSSFCell importfileno = row.getCell(6);
//                                            XSSFCell importcompany= row.getCell(7);
//                                            XSSFCell importcheckin = row.getCell(8);
//                                            XSSFCell importcheckout = row.getCell(9);
//                                            rowcount++;
//                                            while(!sheet.getRow(rowcount).getCell(0).getRawValue().isEmpty()){
//                                                row = sheet.getRow(rowcount);
//                                                importid = row.getCell(0);
//                                                importname= row.getCell(1);
//                                                importroomno = row.getCell(2);
//                                                importroomtype = row.getCell(3);
//                                                importfoodtype = row.getCell(4);
//                                                importbathroom = row.getCell(5);
//                                                importfileno = row.getCell(6);
//                                                importcompany= row.getCell(7);
//                                                importcheckin = row.getCell(8);
//                                                importcheckout = row.getCell(9);
//                                                try{
//                                                    System.out.println((int)importid.getNumericCellValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
//                                                    System.out.println(importname.getStringCellValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
//                                                    System.out.println(importroomno.getRawValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
//                                                    System.out.println(importroomtype.getStringCellValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
//                                                    System.out.println(importfoodtype.getStringCellValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
...
//                                                }
//                                                try{
//                                                    System.out.println(importfileno.getRawValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
//                                                    System.out.println(importcompany.getDateCellValue());
//                                                }catch(Exception ex){
//                                                }
//                                                try{
//                                                    System.out.println(importcheckin.getDateCellValue());
...
//                                                }
//                                                try{
//                                                    System.out.println(importcheckout.getDateCellValue());
//                                                }catch(Exception ex){
...
//                                                out.println("<tr>");
//                                                out.println("<td>");
//                                                out.println(importid);
//                                                out.println("</td>");
//                                                out.println("<td width=\"25%\" >");
//                                                out.println(importname);
//                                                out.println("</td>");
//                                                out.println("<td width=\"10%\" align=\"center\">");
//                                                out.println(importroomno);
//                                                out.println("</td>");
//                                                out.println("<td width=\"5%\" align=\"center\">");
//                                                out.println(importroomtype);
//                                                out.println("</td>");
//                                                out.println("<td width=\"8%\" align=\"center\">");
//                                                out.println(importfoodtype);
//                                                out.println("</td>");
//                                                out.println("<td>");
//                                                out.println(importfileno);
//                                                out.println("</td>");
//                                                out.println("<td width=\"15%\" align=\"center\">");
//                                                out.println(importcompany);
//                                                out.println("</td>");
//                                                out.println("<td>");
//                                                out.println(importcheckin);
//                                                out.println("</td>");
//                                                out.println("<td>");
//                                                out.println(importcheckout);
//                                                out.println("</td>");
//                                                out.println("</tr>");
                                            }
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        try{
                                            ...
                                            while (rs.next()){
                                                ...
                                                String FileNo = rs.getString("File");
