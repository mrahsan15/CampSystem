<%-- 
    ...
    Created on : Dec 19, 2016, 5:35:09 PM
    Author     : ahsan
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Camp System | Register New Company</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Register Company
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Register Company</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group">
                                ...
                                <div class="portlet-body form">
                                    <form role="form" action="guestcompany" method="post">
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <input type="text" name="companyname" class="form-control" id="form_control_1" placeholder="Company Name">
                                                <label for="form_control_1">Name of the Company</label>
                                                <span class="help-block">Company Name</span>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <input type="date" name="joinedsince" class="form-control" id="form_control_1">
                                                <label for="form_control_1">Joined Since</label>
                                                <span class="help-block">Insert the Guest company Details</span>
                                            </div>
                                        </div>
