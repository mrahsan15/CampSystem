<%-- 
    ...
    Created on : Jun 11, 2017, 3:44:23 PM
    Author     : ahsan
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Update | Camp System</title>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Update Check
                            <small>Download & Install Update</small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                        ...
                                        <div class="mt-element-step">
                                            ...
                                            <div class="row step-line">
                                                ...
                                                <div class="col-md-4 mt-step-col first done">
                                                    ...
                                                    <div class="mt-step-content font-grey-cascade">Select the File Package</div>
                                                </div>
                                                <div class="col-md-4 mt-step-col active">
                                                    ...
                                                    <div class="mt-step-content font-grey-cascade">Upload File</div>
                                                </div>
                                                <div class="col-md-4 mt-step-col last">
                                                    ...
                                                    <div class="mt-step-content font-grey-cascade">Launched Application</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
