<%-- 
    ...
    Created on : Feb 7, 2017, 8:09:52 PM
    Author     : ahsan
--%>
...
try{
    if(requestType != null){
        ...
        if(requestType.equals("contact")){
            ...
            if(FirstName != null){
                UserUpdateQuery = "UPDATE campstaff SET FirstName= '"+FirstName+"' WHERE ID = "+campstaffid;
                statement.executeUpdate(UserUpdateQuery);
            }
            String LastName = request.getParameter("LastName");
            if(LastName != null){
                UserUpdateQuery = "UPDATE campstaff SET LastName= '"+LastName+"' WHERE ID = "+campstaffid;
                statement.executeUpdate(UserUpdateQuery);
            }
            ...
            UserUpdateQuery = "UPDATE login SET password = '"+newpassword +"' WHERE campstaffID = "+campstaffid;
            statement.executeUpdate(UserUpdateQuery);
        }
    }
}catch(Exception ex){
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Camp System | Account Settings</title>
                                            ...
                                            <div class="portlet-body">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="profilesettings.jsp" method="post">
                                                    ...
                                                    <div class="tab-pane" id="tab_1_2">
                                                        ...
                                                        <form role="form" action="PictureUpdate?url=<%out.println(request.getServletPath().replace("/", ""));%>" method="post" enctype="multipart/form-data">
