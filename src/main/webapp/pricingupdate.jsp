<%-- 
    Document   : pricingupdate
    Created on : Dec 20, 2016, 11:38:01 AM
    Author     : ahsan
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Camp System | Pricing Update</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Update Price
                        <small>with Categories</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase">Update Pricing</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    <div class="form-group form-md-line-input has-info">
                                                        <input type="hidden" name="requestType" value="pricingupdate">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group form-md-line-input has-warning form-md-floating-label">
                                                                    <div class="input-group left-addon right-addon">
                                                                        ...
                                                                        <input type="text" class="form-control" name="priceperson">
                                                                        <span class="input-group-addon"></span>
                                                                        <label for="form_control_1">Price Per Personnel</label>
                                                                    </div>
                                                                </div>
                                                                </div>
                                                            </div>
