<%-- 
    ...
    Created on : Jan 10, 2017, 2:50:17 PM
    Author     : ahsan
--%>
...
<% 
    ...
    Statement statement = connection.createStatement();
        ...
        ResultSet rs = statement.executeQuery("SELECT JobTitle from campstaff WHERE ID = "+campstaffid);
        rs.next();
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic | Bootstrap Table Master</title>
                        ...
                        <div class="col-md-12">
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body">
                                            <table id="table-pagination" data-toggle="table" data-url="assets/global/plugins/bootstrap-table/data/data2.json" data-height="700" data-pagination="false" data-search="true">
                                                <thead>
                                                    <tr>
                                                        <th data-field="state" data-align="left">Sr#</th>
                                                        <th data-field="id" data-align="left" data-sortable="true">Company Number</th>
                                                        
                                                        <%
                                                        String RoomTypeQuery = "SELECT * FROM datatypes WHERE Type LIKE 'RoomType' ORDER BY datatypes.Value ASC";
                                                        String RoomTypeHeader= "";
                                                        Statement RoomTypeSt = connection.createStatement();
                                                        ResultSet RoomTypeRs = RoomTypeSt.executeQuery(RoomTypeQuery);
                                                        
                                                        
                                                        while(RoomTypeRs.next()){
                                                            RoomTypeHeader = RoomTypeHeader+ RoomTypeRs.getInt("ID") + ",";
...
////                                                        }
                                                        ...
                                                        <th data-field="name" data-align="center" data-sortable="true">Total</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        while(CompanyRs.next()){
                                                            ...
                                                            ResultSet CompanyDetailsRs = CompanyDetailsSt.executeQuery(CompanyDetailsQuery1);
                                                            while(CompanyDetailsRs.next()){
                                                                totalperson++;
                                                            }
                                                            if(totalperson > 0){
                                                                out.println("<tr>");
                                                                ...
                                                                for(int i = 0; i <RoomTypeHeaders.length; i++){
                                                                    String CompanyRoomQuery = "SELECT * FROM datarecord WHERE RoomCategory = "+RoomTypeHeaders[i]+" AND CompanyName = "+CompanyID+" AND CheckIn <= CURRENT_TIMESTAMP AND CheckOut IS NULL ORDER BY CheckOut DESC";
                                                                    Statement CompanyRoomSt = connection.createStatement();
                                                                    ResultSet CompanyRoomRs = CompanyRoomSt.executeQuery(CompanyRoomQuery);
                                                                    int counttype = 0;
