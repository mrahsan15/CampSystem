...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/layouts/layout/css/themes/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color" />me
...
-->                            <ul class="sub-menu">
                        ...
                        <li class="nav-item open active ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item ">
                                    <a href="addsupplier.jsp" class="nav-link ">
                                        <span class="title">Add Supplier</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="viewsupplier.jsp" class="nav-link ">
                                        <span class="title">View Suppliers</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
