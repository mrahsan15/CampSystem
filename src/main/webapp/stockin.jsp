...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Inventory System - Camp System</title>
                                ...
                                <li>
                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="assets/layouts/layout3/img/avatar.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
...
-->                            <ul class="sub-menu">
                        ...
                        <li class="nav-item open active ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item active open ">
                                    <a href="inventory.jsp" class="nav-link ">
                                        <span class="title">Stock Sheet</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a href="stockin.jsp" class="nav-link ">
                                        <span class="title">Stock IN</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a href="stockout.jsp" class="nav-link ">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Store Stocks
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Update Stock</div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    
                                <form role="form" action="StockIn" method="post">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="productid">
                                                    ...
                                                    ResultSet rs = st.executeQuery("SELECT * from stock_products");
                                                    while(rs.next()){
                                                        
                                                        String option = "<option value=\""+rs.getString("ID")+"\">"
                                                                +rs.getString("PRODUCT_CODE_ID")
                                                                +"</option>";
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Entrance Quantity</label>
                                            <div class="input-icon right">
                                                <input type="text" class="form-control" placeholder="Product Quantity" name="entrancequantity"> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-icon right">
                                                <input type="number" class="form-control" placeholder="Price" name="priceperunit"> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <label>Bill No</label>
                                            <div class="input-icon right">
                                                <input type="text" class="form-control" placeholder="Delivery Note" name="deliverynote"> 
                                            </div>
                                        </div>
