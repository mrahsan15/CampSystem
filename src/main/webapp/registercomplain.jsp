                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Register New Complaint</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group">
                                ...
                                <div class="portlet-body form">
                                    <form role="form" action="complainfwd" method="post" id="complainsubmit">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label>Effective Area</label>
                                                <div class="input-icon">
                                                    <i class="fa fa-bell-o font-green"></i>
                                                    <input type="text" class="form-control" placeholder="Effective Area" name="area"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Description</label>
                                                <textarea class="form-control" rows="3" name="complaindescription">
                                                    
                                                </textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Forwarded To</label>
                                                <select name="forwardedto" class="form-control">
                                                    <%
                                                    try{
            ResultSet MaintenanceStaffs = statement
            ...
            while(MaintenanceStaffs.next()){
                ...
                out.println("<option value=\""+id+"\">"+StaffName+"</option>" );
                                            ...
                                            <div class="form-actions">
                                                <button type="submit" class="btn blue" form="complainsubmit" formmethod="post">
                                                    Submit
                                                </button>
