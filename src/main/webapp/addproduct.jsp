...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Add Products - Camp System</title>
                ...
                <div class="page-content">
                    ...
                    <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Add Products</div>
                                    <div class="tools"> </div>
                                </div>
                        ...
                        <div class="col-sm-12">
                        	 <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <textarea class="form-control" row="5" name="productdescription"> </textarea>
                                    </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                        	 <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <input type="text" class="form-control" placeholder="Product Unit" name="productunit"> 
                                    </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                        	 <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <input type="text" class="form-control" placeholder="Product Type" name="producttype"> 
                                    </div>
                            </div>
                        </div>
                        </div>
