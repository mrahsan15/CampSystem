                    ...
                    <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        Statement productlist = connection.createStatement();
                                        ResultSet productset = productlist.executeQuery("SELECT * from stock_products");
                                        while(productset.next()){
                                            out.println("<tr>");
                                            out.println("<td width=\"120\">"+productset.getString("PRODUCT_CODE_ID")+"</td>");
                                            out.println("<td width=\"220\">"+productset.getString("PRODUCT_NAME")+"</td>");
                                            out.println("<td>"+productset.getString("PRODUCT_DESCRIPTION")+"</td>");
                                            out.println("<td width=\"100\">"+productset.getString("PRODUCT_UNIT")+"</td>");
                                            out.println("<td width=\"130\">"+productset.getString("PRODUCT_TYPE")+"</td>");
                                            out.println("</tr>");
                                        }
