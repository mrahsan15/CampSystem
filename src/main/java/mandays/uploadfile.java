...
public class uploadfile extends HttpServlet {
   ...
   public void init( ){
      ...
      filePath = getServletContext().getRealPath("")+File.separator+"uploadedcontent"+File.separator;
      try{
...
//                         fileName.substring( fileName.lastIndexOf("\\")+1)) ;
                      ...
                      response.sendRedirect("mandaysdata.jsp?type=import&file="+newFileName);
