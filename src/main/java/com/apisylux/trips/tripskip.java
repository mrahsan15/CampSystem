 ...
 * @author Pioneer PC
 */
public class tripskip extends HttpServlet {
...
"<html xmlns=\"http://www.w3.org/1999/xhtml\">");
            out.println("<head>");
            out.println("<title>Servlet tripsewage</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try{
                ...
                while(companydata.next()){
                    ...
                    System.out.println("Working 1: "+data);
                ...
                for(int i = 0; i < CompanyArray.size(); i++){
                    ...
                    String queryy = "SELECT * FROM tripprices WHERE CompanyID = "+id+" AND Type LIKE 'Skip'";
                    System.out.println(queryy);
                    ResultSet CompanyDetails = connect.createStatement()
                            .executeQuery("SELECT * FROM tripprices WHERE CompanyID = "+id+" AND Type LIKE 'Skip'");
                    System.out.println("Working 3!");
                    
                    System.out.println("Working 4!");
                    if(CompanyDetails.next()){
                        System.out.println("Working Result Set!");
                        ID = CompanyDetails.getInt("ID");
                        //sizes = CompanyDetails.getString("Size");
                        prices = CompanyDetails.getString("Price");
                        System.out.println("Working 5!: "+ID+","+ CompanyName);
