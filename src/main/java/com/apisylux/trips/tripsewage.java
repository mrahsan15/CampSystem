 ...
 * @author Pioneer PC
 */
public class tripsewage extends HttpServlet {
            ...
            try{
                ...
                for(int i = 0; i < CompanyArray.size(); i++){
                    ...
                    ResultSet CompanyDetails = connect.createStatement()
                            .executeQuery("SELECT * from tripprices WHERE CompanyID = "+id +" AND Type LIKE 'Sewage'");
...
"</select></td></tr>" +
"" +
"<input type=\"hidden\" name=\"type\" value=\"sewage\"  />\n" +
"\n" +
"<br />\n"
        + "<tr><td>" +
