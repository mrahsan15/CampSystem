...
DROP TABLE IF EXISTS `mandayscompanies`;
...
--
-- Dumping data for table `mandayscompanies`
--

LOCK TABLES `mandayscompanies` WRITE;
/*!40000 ALTER TABLE `mandayscompanies` DISABLE KEYS */;
/*!40000 ALTER TABLE `mandayscompanies` ENABLE KEYS */;
UNLOCK TABLES;
