...
DROP TABLE IF EXISTS `stock_exit`;
...
--
-- Dumping data for table `stock_exit`
--

LOCK TABLES `stock_exit` WRITE;
/*!40000 ALTER TABLE `stock_exit` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_exit` ENABLE KEYS */;
UNLOCK TABLES;
